...
La Universidad busca promover la equidad de género y el respeto a la diversidad sexual. Pueden consultar el [Protocolo para la equidad de género y la sexualidad diversa](https://www.eafit.edu.co/centro-integridad/Documents/protocolo-genero-eafit.pdf).
...
-   [Capítulo "Trabajar con datos"](#cap-datos) (10%).

-   [Capítulo "Visualización con datos"](#cap-dataviz) (15%).

-   [Capítulo "Regresión lineal"](#cap-lm-applied) (15%).
