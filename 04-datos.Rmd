...
Usando la función apropiada, cargar el archivo de datos `datos_taller1.csv` (pueden descargarlo de [aquí](https://github.com/josefortou/lab-book/blob/master/data/) a la carpeta `"data/`) como un objeto tipo `tibble`.
